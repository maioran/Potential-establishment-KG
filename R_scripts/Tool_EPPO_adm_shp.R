...
# open eppo shapefile
EPPO.admin.layer <- rgdal::readOGR("Data\\input\\GIS\\EPPOadm_simplified_v05.shp", use_iconv = TRUE, encoding = "UTF-8")
...
#rgdal::writeOGR(EPPO.admin.layer, "Data\\input\\GIS\\EPPOadm_simplified_v05.shp", driver="ESRI Shapefile",layer="EPPOadm_simplified_v02",encoding = "WINDOWS-1252")
# write table
