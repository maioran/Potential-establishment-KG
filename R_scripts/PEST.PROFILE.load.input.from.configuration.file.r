...
i.remove.climates.not.in.EU      <- readxl::read_xlsx("Potential.establishment.KG_Configuration.xlsx", sheet = "Other settings")[[1,2]]
...
i.include.protected.zones        <- readxl::read_xlsx("Potential.establishment.KG_Configuration.xlsx", sheet = "Other settings")[[5,2]]
