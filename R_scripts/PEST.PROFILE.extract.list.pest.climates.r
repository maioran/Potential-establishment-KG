...
if(length(list.files(paste(review.dir, pest.name, "\\REVIEW.Climates",sep="")))==0)
{
...
{
  climate.file.name  <- list.files(paste(review.dir, pest.name, "\\REVIEW.Climates",sep=""))
  climate.file.dir   <- paste(review.dir, pest.name, "\\REVIEW.Climates\\",climate.file.name,sep="")
