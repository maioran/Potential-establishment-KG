...
source("R_scripts\\_SCANClim.admin.layer.fun.r")
...
source("R_scripts\\_SCANClim.extract.climate.fun.r")
# load GIS layers
source("R_scripts\\SCANClim.generate.observations.layers.r")
# Extract the list of climates relevant for the pest (RESOURCE DEMANDING)
source("R_scripts\\SCANClim.extract.list.pest.climates.r")
